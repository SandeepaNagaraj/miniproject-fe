    ...
    return (
        <div className="hidden sm:flex flex-col border-r w-1/4">
            ...
            <div className="flex border-t mt-12 flex-col gap-2 p-6">
                ...
                <p className="text-xs text-gray-400">Control settings for connected experiences across Circle of FOOD, the Facebook app and Messenger, including story and post sharing and logging in.</p>
            </div>
        </div>
    )
}
