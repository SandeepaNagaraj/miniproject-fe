...
const NewPost = ({ newPost, setNewPost }) => {
    ...
    const [experyDay,setExperyDay] = useState('')
    const [experyTime,setExperyTime] = useState('')
    ...
    const newPostSubmitHandler = (e) => {
        ...
        formData.set("madeday",madeDay)
        formData.set("madetime",madeTime)
        formData.set("experyday",experyDay)
        formData.set("experytime",experyTime)
                ...
                <div className="flex sm:flex-row sm:items-start items-center flex-col w-full">
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            type="date"
                            value={experyDay}
                            onChange={(e) => setExperyDay(e.target.value)}
                            className="border rounded px-3 py-2 w-full"
                            placeholder="Enter made day"
                        />
                    </div>
                    <div className="mb-4">
                        ...
                        <input
                            type="text"
                            value={experyTime}
                            onChange={(e) => setExperyTime(e.target.value)}
                            className="border rounded px-3 py-2 w-full"
                            placeholder="Enter made day"
                        />
                    </div>
